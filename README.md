...
[![Version](https://img.shields.io/badge/version-1.0-blue.svg)](https://github.com/tu-usuario/PanelAdminSSH)
...
```bash
wget https://raw.githubusercontent.com/tu-usuario/PanelAdminSSH/main/install.sh -O install.sh && chmod +x install.sh && sudo ./install.sh
```
...
```bash
cd /opt
sudo git clone https://github.com/tu-usuario/PanelAdminSSH.git panel-adminssh
cd panel-adminssh
```
